...
- Add user-specific Daily News settings for enablement, generation time, timezone, and extra editorial instructions.
...
- Allow manual generation and regeneration; regeneration overwrites the current digest version for the selected period.
...
- Surface pending or failed digest states when generation cannot complete, such as missing AI configuration or LLM failure.
